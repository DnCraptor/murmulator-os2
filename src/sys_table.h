...
#define __in_lfa(group) __attribute__((section(".high_flash" group)))
...
| ------------- | ---------- | -----------: | ----------: | -------: | ------------------------------- |
| **BOOT2**     | 0x10000000 |   0x10000FFF |         4.0 |       rx | LOW FLASH AREA (boot-loader)    |
| **PFA**       | 0x10000100 |   0x10DB9FFF |    13 992.0*|       rx | PROGRAM FLASH AREA (paged apps) |
TODO: corrct it
