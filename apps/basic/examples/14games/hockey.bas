...
20 SET 11, 1: REM "Set TAB to MS mode"
25 SET 12, 0: REM "Set arrays starting at 0"
30 LET X=1
40 PRINT:PRINT:PRINT
50 PRINT "WOULD YOU LIKE THE INSTRUCTIONS";:INPUT C$
55 PRINT
60 IF C$="NO" OR C$="no" THEN 90
65 IF C$="YES" OR C$="yes" THEN 80
70 PRINT "ANSWER YES OR NO!!":GOTO 50 
80 GOTO 1720
90 DIM A$(32, 7+1),B$(32, 7+1),H(20+1),T(5+1),T1(5+1),T2(5+1),T3(5+1)
100 PRINT "ENTER THE TWO TEAMS";:INPUT T$: A$()(7)=T$: INPUT T$: B$()(7)=T$
105 PRINT
...
135 PRINT
140 FOR I=1 TO 6:PRINT "PLAYER ";I;:INPUT T$: A$()(I)=T$:NEXT I:PRINT 
150 PRINT "WOULD THE " B$()(7) " COACH DO THE SAME"
155 PRINT
160 FOR T=1 TO 6:PRINT "PLAYER ";T;:INPUT T$: B$()(T)=T$:NEXT T:PRINT 
170 PRINT "INPUT THE REFEREE FOR THIS GAME";:INPUT R$  
180 TAB 10: PRINT A$()(7);" STARTING LINEUP" 
190 FOR T=1 TO 6:PRINT A$()(T):NEXT T  
200 TAB 10: PRINT B$()(7);" STARTING LINEUP"
...
990 REM "FOR B1=1 TO 25:PRINT CHR$(7);:NEXT B1:PRINT"
...
1530 GOTO 1540
1540 NEXT L: REM "FOR N=1 TO 30:PRINT CHR$(7);:NEXT N:PRINT 'THAT'S THE SIREN'" 
1550 TAB 15: PRINT "FINAL SCORE:"
1560 IF H(8)>H(9) THEN 1580
1570 PRINT A$()(7)":";H(9),B$()(7)":";H(8):GOTO 1590
1580 PRINT B$()(7)":";H(8),A$()(7)":";H(9)
1590 TAB 10: PRINT "SCORING SUMMARY":PRINT
1600 TAB 25: PRINT A$()(7)
1610 TAB 5: PRINT "NAME";: TAB 20: PRINT "GOALS";: TAB 35: PRINT "ASSISTS"
1620 TAB 5: PRINT "----";: TAB 20: PRINT "-----";: TAB 35: PRINT "-------"
1630 FOR I=1 TO 5: TAB 5: PRINT A$()(I);: TAB 21: PRINT T(I);: TAB 36: PRINT T1(I) 
1640 NEXT I:PRINT 
1650 TAB 25: PRINT B$()(7)
1660 TAB 5: PRINT "NAME";: TAB 20: PRINT "GOALS";: TAB 35: PRINT "ASSISTS"  
1670 TAB 5: PRINT "----";: TAB 20: PRINT "-----";: TAB 35: PRINT "-------"
1680 FOR T=1 TO 5: TAB 5: PRINT B$()(T);: TAB 21: PRINT T2(T);: TAB 36: PRINT T3(T)
1690 NEXT T:PRINT 
