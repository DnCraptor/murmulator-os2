...
400 PRINT O$()(P+1);" WON THE TOSS"
410 DEF FNF(X)=1-2*P
420 DEF FNG(Z)=P*(X1-X)+(1-P)*(X-X1)
430 IF P=0 THEN 470
440 PRINT O$()(1+1);" ELECTS TO RECEIVE."
450 PRINT
460 GOTO 580
...
560 LET P=1
580 LET X=40+(1-P)*20
590 LET Y=INT(200*POW(RND(1)-.5,3)+55)
600 PRINT Y;L$()(3);" KICKOFF"
610 LET X=X-FNF(1)*Y
620 IF ABS(X-50)>=50 THEN 700
630 LET Y=INT(50*POW(RND(1),2))+(1-P)*INT(50*POW(RND(1),4))
640 LET X=X+FNF(1)*Y
...
655 PRINT L$()(4);
660 GOTO 2600
700 PRINT "TOUCHBACK FOR ";O$()(P+1);"."
710 LET X=20+P*60
720 REM "FIRST DOWN"
730 GOSUB 800
740 LET X1=X
750 LET D=1
760 PRINT:PRINT "FIRST DOWN ";O$()(P+1);"***"
770 PRINT
780 PRINT
790 GOTO 860
800 REM "PRINT POSITION"
810 IF X>50 THEN 840
820 PRINT L$()(5),O$()(0+1),X,L$()(6)
830 GOTO 850
840 PRINT L$()(5),O$()(1+1),100-X,L$()(6)
850 RETURN
860 REM "NEW PLAY"
870 LET T=T+1
...
920 PRINT "FINAL SCORE:  ";O$()(0+1);": ";S(0+1);"  ";O$()(1+1);": ";S(1+1)
930 STOP
...
1250 GOTO 2450
1260 REM  "SHORT PASS"
1270 LET Y=INT(60*POW(R1-.5, 3)+10)
...
1470 GOTO 2190
1480 REM  "LONG PASS"
1490 LET Y=INT(160*POW(R1-.5, 3)+30)
...
2510 REM "SAFETY"
2520 LET S(1-P+1)=S(1-P+1)+2
2530 PRINT L$()(19)
2540 GOSUB 2800
2550 PRINT O$()(P+1);" KICKS OFF FROM ITS 20 YARD LINE."
2560 LET X=20+P*60
2570 LET P=1-P
2580 GOTO 590
...
2620 LET S(P+1)=S(P+1)+7
2630 PRINT "KICK IS GOOD."
2640 GOSUB 2800
2650 PRINT O$()(P+1);" KICKS OFF"
2660 LET P=1-P
2670 GOTO 580
2680 PRINT "KICK IS OFF TO THE SIDE"
2690 LET S(P+1)=S(P+1)+6
2700 GOTO 2640
2710 REM "TOUCHBACK"
2720 PRINT L$()(18)
2730 LET P=1-P
...
2770 PRINT L$()(17);"FOR ";O$()(1-P+1);"***"
2780 LET P=1-P
2790 GOTO 2600
2800 REM "SCORE"
2810 PRINT
2820 PRINT "SCORE:  ";S(0+1);" TO ";S(1+1)
2830 PRINT
2840 PRINT
2850 RETURN
2860 REM "PENALTY"
2870 LET P3=INT(2*RND(1))
2880 PRINT O$()(P3+1);" OFFSIDES -- PENALTY OF 5 YARDS."
2890 PRINT
2900 PRINT
