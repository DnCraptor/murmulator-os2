...
20 SET 11, 1: REM "TAB Command in MS mode"
...
60 PRINT "THROW";: TAB 20: PRINT "DESCRIPTION";
65 TAB 45: PRINT "PROBABLE SCORE"
70 PRINT " 1";: TAB 20: PRINT "FAST OVERARM";
75 TAB 45: PRINT "BULLSEYE OR COMPLETE MISS"
80 PRINT " 2";: TAB 20: PRINT "CONTROLLED OVERARM";
85 TAB 45: PRINT "10, 20 OR 30 POINTS"
90 PRINT " 3";: TAB 20: PRINT "UNDERARM";
95 TAB 45: PRINT "ANYTHING":PRINT
100 DIM A$(32,20),S(20),W(10): M=0: R=0: FOR I=1 TO 20: S(I)=0: NEXT I
110 INPUT "HOW MANY PLAYERS? ";N: PRINT
120 FOR I=1 TO N
130 PRINT "NAME OF PLAYER #";I;"? ":INPUT T$: A$()(I)=T$
140 NEXT I
