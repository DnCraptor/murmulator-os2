10 REM "WEEKDAY from 101 BASIC computer games"
...
140 INPUT "MONTH: ", M1: INPUT "DAY: ", D1: INPUT "YEAR: ",Y1
...
250 INPUT "MONTH: ", M: INPUT "DAY: ", D: INPUT "YEAR: ",Y
260 PRINT
...
800 LET I5=I5-1
810 LET I6=I6+12
820 IF I5<0 THEN 1300
830 IF I7 <> 0 THEN 850
835 IF I6 <> 0 THEN 850
840 PRINT "***HAPPY BIRTHDAY***"
850 TAB 25: PRINT "YEARS","MONTHS","DAYS"
855 TAB 25: PRINT "-----","------","----"
860 PRINT "YOUR AGE (IF BIRTHDATE) ";#5; I5,I6,I7
...
940 LET F = 0.35
950 PRINT "YOU HAVE SLEPT ";: TAB 25
960 GOSUB 1370
970 LET F = 0.17
980 PRINT "YOU HAVE EATEN ";: TAB 25
990 GOSUB 1370
1000 LET F = 0.23
1010 IF K5 > 3 THEN 1040
1020 PRINT "YOU HAVE PLAYED";: TAB 25
1030 GOTO 1080
1040 IF K5 > 9 THEN 1070
1050 PRINT "YOU HAVE PLAYED/STUDIED";:TAB 25
1060 GOTO  1080
1070 PRINT "YOU HAVE WORKED/PLAYED";:TAB 25
1080 GOSUB 1370
1085 GOTO 1530
1090 PRINT "YOU HAVE RELAXED ";: TAB 25: PRINT #5; K5,K6,K7
1100 PRINT 
1110 TAB 16: PRINT "***  YOU MAY RETIRE IN ";E;" ***"
1120 PRINT
1140 PRINT
1200 PRINT
1210 PRINT
