2 REM "MASTERMIND"
4 REM "Ported by Stefan 2022"
8 SET 11, 1: REM "Set the TAB command to MS mode"
10 REM
...
140 H=0:C=0
150 DIM Q(P9),S(10,2),S$(32,10),A$(32,P9),G$(32,P9),I(P),H$(32,P9)
160 L$="BWRGOYPT"
170 PRINT
180 PRINT
...
210 FOR X=1 TO C9
220 READ X$
230 PRINT X$;: TAB 13: PRINT L$(X,X)
240 NEXT X
250 PRINT
260 FOR R=1 TO R9
270 PRINT 
...
430 FOR X=1 TO P9
440 FOR Y=1 TO C9
450 IF X$(X,X)=L$(Y,Y) THEN 480
460 NEXT Y
470 PRINT "'"; X$(X,X); "' IS UNRECOGNIZED.":GOTO 380
480 G$()(X)=X$(X,X)
490 NEXT X
...
2050 FOR Z=1 TO M-1
2060 PRINT Z;: TAB 9: PRINT S$()(Z);: TAB 25: PRINT S(Z,1);: TAB 35: PRINT S(Z,2)
2070 NEXT Z
2075 PRINT
2080 GOTO 380
2500 REM
...
4645 W=W+1:A$()(T)=F:G$()(S)=F+1:F=F+2:GOTO 4660
4650 NEXT T
4660 NEXT S
4670 RETURN
5000 REM
