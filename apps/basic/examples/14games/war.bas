10 REM "WAR from 101 BASIC games"
20 REM "Ported by Stefan in 2022"
30 REM "FNI(X) is the index function to split the string"
40 DEF FNI(X)=(X-1)*3+1
...
130 INPUT B$
140 IF B$="NO" OR B$="no" THEN 210
150 IF B$="YES" OR B$="yes" THEN 180
...
390 M2=L(P)
400 PRINT
420 PRINT "YOU: ";A$(FNI(M1), FNI(M1)+2),"COMPUTER: ";A$(FNI(M2), FNI(M2)+2)
430 N1=INT((M1-0.5)/4)
440 N2=INT((M2-0.5)/4)
...
560 INPUT V$
570 IF V$="YES" OR V$="yes" THEN 360
580 IF V$="NO" OR V$="no" THEN 650
