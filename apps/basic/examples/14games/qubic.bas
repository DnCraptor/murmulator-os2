50 REM "PRINT CHR$(26):REM WIDTH 80"
100 REM "QUBIC"
110 REM "Ported by Stefan in 2022"
120 REM
210 PRINT "DO YOU WANT INSTRUCTIONS";
220 INPUT C$
230 IF C$(1,1)="N" OR C$(1,1)="n" THEN 315
240 IF C$(1,1)="Y" OR C$(1,1)="y" THEN 265
...
450 INPUT S$
460 IF S$(1,1)="N" OR S$(1,1)="n" THEN 630
470 IF S$(1,1)="Y" OR S$(1,1)="y" THEN 500
...
1510 INPUT X$
1520 IF X$(1,1)="Y" OR X$(1,1)="y" THEN 400
1530 IF X$(1,1)="N" OR X$(1,1)="n" THEN 1560
