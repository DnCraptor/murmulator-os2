...
120 REM "Array bounds problem - unfinished - more thought needed"
130 SET 11,1 : REM "MS style TAB"
140 SET 12,0 : REM "Set lower array bound to zero"
210 DIM S(8+1)
220 PRINT "WELCOME TO SOUTH PORTLAND HIGH RACETRACK"
230 PRINT "                      ...OWNED BY LAURIE CHEVALIER"
240 PRINT "DO YOU WANT DIRECTIONS";
250 INPUT X$
260 IF X$="NO" OR X$="no" THEN 320
...
570 FOR N=1 TO 8
580 PRINT V$()(N);: TAB 14: PRINT #8,N,#0,R/D(N);":1"
590 NEXT N
600 PRINT"--------------------------------------------------"
...
1376 IF O$="YES" OR O$= "yes" THEN 380
1380 END
