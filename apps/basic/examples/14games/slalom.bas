10 REM "SLALOM"
20 REM "CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
30 REM 
40 REM "this is the double quote"
50 C$=34
...
750 INPUT B$
760 REM
770 IF B$="NO" OR B$="no" THEN 1740
780 IF B$="YES" OR B$="yes" THEN 480
...
1430 GOTO 580
1440 PRINT
1445 PRINT "TYPE ";C$;"INS";C$;" FOR INSTRUCTIONS"
1450 PRINT "TYPE ";C$;"MAX";C$;" FOR APPROXIMATE MAXIMUM SPEEDS"
1460 PRINT "TYPE ";C$;"RUN";C$;" FOR THE BEGINNING OF THE RACE"
1470 PRINT "COMMAND--";
1480 INPUT A$
1490 REM
...
1530 PRINT C$;A$;C$;" IS AN ILLEGAL COMMAND--RETRY";
1540 GOTO 1480
1550 PRINT "GATE MAX"
1560 PRINT " #  M.P.H."
1570 PRINT"----------"
