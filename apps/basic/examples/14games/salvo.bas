1000 REM "SALVO"
1010 REM "Ported by Stefan in 2022"
1020 REM
1030 REM
...
1430 IF SQR(POW(F(Z3)-F(Z2),2)+POW(G(Z3)-G(Z2),2)) < 3.59 THEN 1260
1440 NEXT Z3
1450 NEXT Z2
...
1520 FOR X=1 TO 5
1530 REM "INPUT Y,Z"
1535 GOSUB 5000: Y=TX: Z=TY
1540 B(Y,Z)=3
1550 NEXT X
1560 PRINT "CRUISER"
1570 FOR X=1 TO 3
1580 REM "INPUT Y,Z"
1585 GOSUB 5000: Y=TX: Z=TY
1590 B(Y,Z)=2
1600 NEXT X
1610 PRINT "DESTROYER<A>"
1620 FOR X=1 TO 2
1630 REM "INPUT Y,Z"
1635 GOSUB 5000: Y=TX: Z=TY
1640 B(Y,Z)=1
1650 NEXT X
1660 PRINT "DESTROYER<B>"
1670 FOR X=1 TO 2
1680 REM "INPUT Y,Z"
1685 GOSUB 5000: Y=TX: Z=TY
1690 B(Y,Z)=.5
1700 NEXT X
...
5020 INPUT "X, Y? ",N$ : IF N$="#" THEN END
