...
79 PRINT
80 INPUT "CHOOSE YOUR OPPONENT - GIVE A NAME: ";O$
...
1195 GOTO 3000
1200 IF RND(1)>0.782*D/8 THEN 1250
1210 PRINT "SHOT IS BLOCKED.  BALL CONTROLLED BY ";
1230 IF RND(1)>0.5 THEN 1242
1235 PRINT "DARTMOUTH."
1240 GOTO 430
1242 PRINT O$;"."
1245 GOTO 3000
1250 IF RND(1)>0.843*D/8 THEN 1270
...
1320 PRINT "LAY UP."
1330 IF 7/D*RND(1)>0.4 THEN 1360
1340 PRINT "SHOT IS GOOD.  TWO POINTS."
1345 GOSUB 7000
1355 GOTO 3000
1360 IF 7/D*RND(1)>0.7 THEN 1500
...
1450 GOTO 430
1500 IF 7/D*RND(1)>0.875 THEN 1600
1510 PRINT "SHOOTER FOULED.  TWO SHOTS."
1520 GOSUB 4000
1530 GOTO 3000
1600 IF 7/D*RND(1)>0.925 THEN 1630
...
3080 GOSUB 6000
3090 GOTO 425
3100 IF 8/D*RND(1)>0.75 THEN 3200
3105 PRINT "SHOT IS OFF RIM."
3110 IF D/6*RND(1)>0.5 THEN 3150
...
3170 GOTO 3000
3175 GOTO 3500
3200 IF 8/D*RND(1)>0.9 THEN 3310
...
3510 PRINT "LAY UP."
3520 IF 7/D*RND(1)>0.413 THEN 3600
