...
390 IF R(E+1,L+1)=1 THEN 480
400 R(E+1,L+1)=R(E+1,L+1)-1
410 GOTO 70
...
470 GOTO 230
480 IF R(E1+1,L1+1)=1 THEN 70
490 R(E1+1,L1+1)=R(E1+1,L1+1)-1
500 GOTO 70
