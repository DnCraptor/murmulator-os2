...
280 PRINT "PLEASE PREPARE A TAPE AND RUN.": REM "STOP"
...
430 FOR I=1 TO 20
440 REM
450 PRINT C(I+L);: TAB 6: PRINT P$()(I)
460 NEXT I
630 L=L+20:T=2
640 PRINT
...
840 IF A$="YES" OR A$="yes" THEN 1430
845 IF A$<>"NO" AND A$<>"no" THEN 830
...
898 C=8
900 IF C=8 THEN 904
901 TAB 27: PRINT 10-(Y(T)*P-Y(T)*S);" YARDS TO 1ST DOWN"
902 GOTO 910
904 TAB 27: PRINT X(T)-Y(T)*P;" YARDS"
...
1185 IF A$="NO" OR A$="no" THEN 1200
1187 IF A$<>"YES" AND A$<>"yes" THEN 1180
...
1210 IF A$="YES" OR A$="yes" THEN 1640
1215 IF A$<>"NO" AND A$<>"no" THEN 1200
1217 GOTO 920
...
1290 P=Z(T)-W(T)*20: IF A$="YES" OR A$="yes" THEN 1190
