10 REM "REVERSE from 101 BASIC games"
20 REM "Ported from Stefan's BASIC in 2021"
30 REM
40 DIM A(20)
...
170 INPUT A$
180 IF A$(1,1)="Y" OR A$(1,1)="y" THEN GOSUB 710
200 REM *** MAKE A RANDOM LIST A(1) TO A(N)
210 A(1)=INT(RND(N-1)+2)
220 FOR K=2 TO N
230 A(K)=INT(RND(N)+1)
240 FOR J=1 TO K-1
...
540 INPUT A$
550 IF A$(1,1)="Y" OR A$(1,1)="y" THEN 210
