...
10 REM "Set TAB to MS mode"
11 SET 11, 1
14 DIM B(19,9),M(19,4),S(9),P$(3)
15 W=0: L=0
...
623 S(FNM(M(X,Y)))=-1
624 GOTO 640
630 PRINT "I MOVE FROM ";FNR(INT(M(X,Y)/10));" TO ";
631 PRINT FNR(FNM(M(X,Y)))
634 S(FNR(INT(M(X,Y)/10)))=0
635 S(FNR(FNM(M(X,Y))))=-1
640 GOSUB 1000
...
1010 FOR I=1 TO 3
1020 FOR J=1 TO 3
1030 TAB 10: PRINT P$(S((I-1)*3+J)+2,S((I-1)*3+J)+2);
1040 NEXT J
1050 PRINT
1060 NEXT I
1070 PRINT
...
2170 TAB 10: PRINT "123": TAB 10: PRINT "456": TAB 10: PRINT "789"
...
5040 TC=INSTR(N$, ","): IF TC=0 THEN PRINT "ERROR": GOTO 5020
