...
18 GOSUB 1402 
19 IF B$(1,3)="YES" OR B$(1,3)="yes" THEN 100
21 STOP
100 PRINT
101 PRINT "YOU HAVE $";I " SAVINGS."
102 PRINT "AND 190 FURS TO BEGIN THE EXPEDITION."
261 LET E1=INT((.15*RND(1)+.95)*100+.5)/100
262 LET B1=INT((.25*RND(1)+1.00)*100+.5)/100
300 PRINT
...
338 INPUT F(J+1) 
340 LET F(0+1)=F(1+1)+F(2+1)+F(3+1)+F(4+1) 
342 IF F(0+1)=190 THEN 1100
344 IF F(0+1)>190 THEN 500 
348 NEXT J 
350 GOTO 1100 
500 PRINT
...
1125 GOSUB 1400 
1129 IF B$(1,3)="YES" OR B$(1,3)="yes" THEN 1110
1130 GOTO 1160
...
1141 GOSUB 1400 
1144 IF B$(1,3)="YES" OR B$(1,3)="yes" THEN 1110
1145 GOTO 1198
...
1152 GOSUB 1400 
1155 IF B$(1,3)="YES" OR B$(1,3)="yes" THEN 1110
1156 GOTO 1250
1160 LET I=I-160
1169 PRINT
1174 LET M1=INT((.2*RND(1)+.7)*100+.5)/100
1175 LET E1=INT((.2*RND(1)+.65)*100+.5)/100
1176 LET B1=INT((.2*RND(1)+.75)*100+.5)/100
1177 LET D1=INT((.2*RND(1)+.8)*100+.5)/100
1180 PRINT "SUPPLIES AT FORT HOCHELAGA COST $150.00."
1181 PRINT "YOUR TRAVEL EXPENSES TO HOCHELAGA WERE $10.00."
1190 GOTO 1410 
1198 LET I=I-140
1201 PRINT
1205 LET M1=INT((.3*RND(1)+.85)*100+.5)/100
1206 LET E1=INT((.15*RND(1)+.8)*100+.5)/100
1207 LET B1=INT((.2*RND(1)+.9)*100+.5)/100
...
1250 LET I=I-105
1254 PRINT
1260 LET M1=INT((.15*RND(1)+1.05)*100+.5)/100
1263 LET D1=INT((.25*RND(1)+1.1)*100+.5)/100
...
1404 RETURN 
1410 PRINT
1412 PRINT "YOUR BEAVER SOLD FOR $";B1*F(2+1);
1414 PRINT " YOUR FOX SOLD FOR $";D1*F(4+1)
1416 PRINT "YOUR ERMINE SOLD FOR $";E1*F(3+1);
1417 PRINT " YOUR MINK SOLD FOR $";M1*F(1+1)
1418 LET I=M1*F(1+1)+B1*F(2+1)+E1*F(3+1)+D1*F(4+1)+I
1420 PRINT
