2 REM "Settings for the BASIC Interpreter"
4 SET 11,1: REM "Set TAB to MS mode"
...
215 REM "***"
216 REM "Ported by Stefan in 2022 to Arduino IoT BASIC"
...
1600 FOR I=1 TO 3:K(I,3)=0:NEXT I:REM "Q$=Z$+Z$+Z$+Z$+Z$+Z$+Z$+LEFT$(Z$,17)"
1610 Q$="": FOR I=1 TO 6:Q$(LEN(Q$)+1)=Z$: NEXT: Q$(LEN(Q$)+1)=Z$(1,17)
...
2080 FOR I=1 TO 9:IF A$(1,3)<>A1$(3*I-2,3*I) THEN 2160
...
2530 IF S<N-EORD(7)<0 THEN 1990
...
2840 TAB 8:R1=I:GOSUB 8790:PRINT G2$;" REPAIR COMPLETED."
...
3240 S8=INT(S1)*24+INT(S2)*3-26:IF Q$(S8,S8+1)="  "THEN 3360
...
4210 T$=STR(N(L)+1000):PRINT T$(1,3);" ";
...
5920 GOSUB 8790:PRINT G2$;: TAB 25: PRINT INT(D(R1)*100)*.01
...
6330 INPUT"LET HIM STEP FORWARD AND ENTER 'AYE'";A$:IFA$="AYE"THEN CLR: GOTO 10
6360 END
...
6820 FOR J=(I-1)*24+1TO(I-1)*24+22 STEP 3:PRINT" ";Q$(J,J+2);:NEXT J
...
7700 TT$=STR(Z(I,J)+1000): PRINT TT$(LEN(TT$)-2,LEN(TT$))
7720 NEXT J:GOTO 7850
7740 Z4=I:Z5=1:GOSUB 9030:J0=INT(15-.5*LEN(G2$)):TAB J0:PRINT G2$;
7800 Z5=5:GOSUB 9030:J0=INT(39-.5*LEN(G2$)):TAB J0: PRINT G2$;
...
8350 IFA>0THEN C1=3:GOTO 8420
8360 IFX<>0THEN C1=5:GOTO 8290
8410 C1=7
8420 IFABS(A)>=ABS(X)THEN8450
8430 PRINT"DIRECTION =";C1+(((ABS(X)-ABS(A))+ABS(X))/ABS(X)):GOTO8460
8450 PRINT"DIRECTION =";C1+(ABS(X)/ABS(A))
8460 PRINT"DISTANCE =";SQR(POW(X,2)+POW(A,2)):IFH8=1THEN1990
8480 NEXTI:GOTO1990
...
8676 Q2=LEN(Q$):Q1=1:IF Q2-189>0 THEN Q1=Q2-189
8680 IF S8=1 THEN TT$=A$: TT$(LEN(TT$)+1)=Q$(Q1,Q2):Q$=TT$: RETURN
8690 IF S8=190 THEN Q$=Q$(1,189):Q$(190)=A$:RETURN
8700 TT$=Q$(1,S8-1):TT$(S8)=A$:IF Q2-190+S8>0 THEN Q1=Q2-190+S8
8710 TT$(LEN(TT$)+1)=Q$(Q1,Q2): Q$=TT$: RETURN
8720 REM "Q$=LEFT$(Q$,S8-1)+A$+RIGHT$(Q$,190-S8):RETURN"
...
8890 IF Q$(S8,S8+2)<>A$ THEN RETURN
8900 Z3=1:RETURN
...
9220 RETURN
9230 G2$(LEN(G2$)+1)=" I":RETURN
9240 G2$(LEN(G2$)+1)=" II":RETURN
9250 G2$(LEN(G2$)+1)=" III":RETURN
9260 G2$(LEN(G2$)+1)=" IV":RETURN
