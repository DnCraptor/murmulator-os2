...
1395 DEF FND(Q)=(4.5+L/6-(D(1)+D(2))*2.5+4*D(4)+2*D(5)-POW(D(3),2)/120-A)
...
1920 REM
1930 INPUT A$
1940 IF A$="YES" OR A$="yes" THEN 1990
1950 IF A$="NO" OR A$="no" THEN 2010
