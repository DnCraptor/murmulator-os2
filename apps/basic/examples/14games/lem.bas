...
125 S=0
130 C=0
135 IF Z$="YES" OR Z$="yes" THEN 1150
140 PRINT
...
160 PRINT " (YES OR NO)";
165 INPUT Q$
170 IF Q$="YES" OR Q$="yes" THEN 190
175 IF Q$="NO" OR Q$="no" THEN 205
...
380 PRINT
385 TAB 30: PRINT "-180|+180"
390 TAB 34: PRINT "^"
395 TAB 27: PRINT "-90 < -+- > +90"
400 TAB 34: PRINT "!"
405 TAB 34: PRINT "0"
410 TAB 21: PRINT "<<<< DIRECTION OF ORBIT <<<<"
415 PRINT
420 TAB 20: PRINT "------ SURFACE OF MOON ------"
425 PRINT
430 PRINT
...
505 PRINT
510 IF Q$="YES" OR Q$="yes" THEN 535
...
581 INPUT N$
582 T1=VAL(N$)
583 I=INSTR(N$, ",")+1: F=VAL(N$(I))
584 I=INSTR(N$(I), ",")+1: P=VAL(N$(I))
585 REM "INPUT T1,F,P"
590 F=F/100
...
650 C=COS(P)
655 M2=M0*T1*F/B
660 R3=-.5*R0*(POW(V0/R, 2))+R*A1*A1
665 A3=-2*R1*A1/R
670 FOR I=1 TO N
...
725 M=M-.5*M2
730 R4=R3
735 R3=-.5*R0*(POW(V0/R,2))+R*A1*A1
...
1110 INPUT Z$
1115 IF Z$="YES" OR Z$="yes" THEN 20
1120 IF Z$="NO" OR Z$="no" THEN 1130
1125 GOTO 1105
1130 PRINT
