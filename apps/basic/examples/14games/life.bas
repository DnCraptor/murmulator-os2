2 REM "LIFE"
4 REM "Printed by Stefan in 2022"
6 REM
7 SET 11,1: REM "Set TAB to MS mode"
8 PRINT "ENTER YOUR PATTERN:"
9 X1=1: Y1=1: X2=24: Y2=70
10 DIM A(24,70),B$(72, 24)
20 C=1
30 INPUT T$: B$()(C)=T$
40 IF B$()(C)="DONE" THEN B$(C)="": GOTO 80
50 IF B$(1,1)(C)="." THEN T$=" ": T$(2)=B$(2)(C): B$()(C)=T$
60 C=C+1
70 GOTO 30
80 C=C-1: L=0
90 FOR X=1 TO C-1
...
160 IF B$(Y,Y)(X)<>" " THEN A(X1+X,Y1+Y)=1:P=P+1
170 NEXT Y
180 NEXT X
