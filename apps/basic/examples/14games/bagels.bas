10 REM "Bagels from 101 BASIC games"
11 REM  "Originally written by D. Resek and P. Rowe"
12 REM "Ported to Stefan's BASIC in 2021"
15 @R=MILLIS(1)
30 DIM A1(6),A(3),B(3)
40 Y=0:T=255
50 PRINT
70 INPUT "WOULD YOU LIKE THE RULES (YES OR NO)";A$
90 IF A$(1,1)="N" OR A$(1,1)="n" THEN 150
...
250 FOR Z=1 TO 3:A1(Z)=A$(Z,Z):NEXT Z
260 FOR J=1 TO 3
...
720 IF A$(1,1)="Y"  OR A$(1,1) = "y" THEN 150
730 IF Y=0 THEN 750
