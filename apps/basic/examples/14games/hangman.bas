...
160 L=LEN(A$): FOR I=1 TO LEN(A$): L(I)=A$(I,I): NEXT I
170 PRINT "HERE ARE THE LETTERS YOU USED:"
180 FOR I=1 TO 26: PUT N(I): IF N(I+1)="" THEN 200
190 PRINT ",";: NEXT I
200 PRINT: PRINT: FOR I=1 TO L: PUT D(I): NEXT I: PRINT: PRINT
...
310 NEXT I: GOTO 390
320 PRINT: FOR I=1 TO L: PUT D(I): NEXT I: PRINT: PRINT
...
570 P(12,3)="-": P(12,4)="/"
580 FOR I=1 TO 12: FOR J=1 TO 12: PUT P(I,J): NEXT J
...
620 INPUT "TYPE YES OR NO";Y$: IF Y$(1,1)="Y" THEN 50
